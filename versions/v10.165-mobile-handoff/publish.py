...
PREFIX = 'previews/v10.165-20260914-' + fingerprint[:12] + '/'
...
assert b'V10.165' in html and b'href="#our-story"' in html
...
plan = dict(version='V10.165', baseRevision=REV, sourceFingerprint=fingerprint, bucket=BUCKET,
