...
PREFIX = 'previews/v10.168-20260914-' + fingerprint[:12] + '/'
...
assert b'V10.168' in html and b'href="#our-story"' in html
...
plan = dict(version='V10.168', baseRevision=REV, sourceFingerprint=fingerprint, bucket=BUCKET,
