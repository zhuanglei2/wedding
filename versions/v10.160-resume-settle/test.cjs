...
async function fixture({reduced=false,noWAAPI=false,broken=false,paperHeight=850,screenHeight=850,introHeight=280,wrap=18,rowHeight=28,scrollQuantum=0,frameStep=32,sourceOverride=null}={}){
...
(async()=>{
 ...
 console.log('PASS: V10.159 freeze reproduced; V10.160 continues with integer/half/third-pixel scrolling, 8/16/32ms frames, both directions, clamped scroll bounds and photo flights.');
