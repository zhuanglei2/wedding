/* V10.126: ordered deferred runtime bundle. */
;
...
(function(scope){
  ...
  function create(stage){
    ...
    function prepare(stageWidth){
      ...
      for(let i=0;i<COUNT;i++){
        const band=document.createElement('div');band.className='paper-strip';
        band.style.height=(height/COUNT+.45)+'px';
        const face=document.createElement('div');face.className='paper-strip-face';face.style.height=height+'px';
