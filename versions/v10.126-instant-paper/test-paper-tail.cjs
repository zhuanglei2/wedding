...
for(const name of ['page-turn.js','handoff-math.js']){
...
assert.equal(rules(css).replaceAll('../v10.125-keepsake-fast/media/camera-art.webp','../v10.111-camera-invitation/camera-invitation.png'),rules(read(prior,'camera-story.css')),'Names/date and bilingual caption unchanged');
