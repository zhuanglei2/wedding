...
async function setup(options={}){
  ...
  const events={},queue=new Map(),timers=new Map(),draws=[],paperDraws=[],paperPrepares=[];let id=0,paperClears=0;
  ...
  return{win,doc,stage,mirror,root,reduce,draws,emit,tick,queue,timers,status,paperDraws,paperPrepares,get paperClears(){return paperClears}};
}
(async()=>{
