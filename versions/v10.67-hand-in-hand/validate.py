...
old=here.parent/'v10.66-together-flight'
...
assert 'V10.67' in html
surface='<div class="paper-slices" aria-hidden="true"></div>\n'
assert html.replace('V10.67','V10.66')==old_html, 'Unexpected invitation/chapter markup changes'
for name in ('page-turn.js','page-turn.css','paper-surface.js'):
