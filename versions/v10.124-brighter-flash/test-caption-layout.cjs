...
for(const file of ['camera-story.js','page-turn.js','page-media.js','handoff-math.js']){
...
console.log('PASS: bilingual caption, original type/color, names/date, photo layout, flight and loading preserved; 6 display widths and inline CSS verified. No browser visual claim.');
