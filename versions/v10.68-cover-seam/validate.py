...
old=here.parent/'v10.67-hand-in-hand'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg','classic-reveal.webp','classic-reveal.jpg','titles.css','star-couple.png','star-couple-reference.jpg','rig-atlas.png','rig-atlas-original.png','character-rig.js','star-trail.js'):
...
assert 'V10.68' in html
surface='<div class="paper-slices" aria-hidden="true"></div>\n'
assert html.replace('V10.68','V10.67')==old_html, 'Unexpected invitation/chapter markup changes'
for name in ('page-turn-math.js','page-turn.css','paper-surface.js'):
