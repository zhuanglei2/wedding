...
async function setup(options={}){
  ...
  const stageRect=()=>({left:options.left||0,top:coverHeight-win.scrollY,width,height:width*1.5,bottom:coverHeight+width*1.5-win.scrollY});
  stage.getBoundingClientRect=stageRect;nodes['#our-story'].getBoundingClientRect=stageRect;nodes['#our-story'].image=stage;
