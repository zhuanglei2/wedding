...
old=here.parent/'v10.55-quality-webp'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg'):
...
start='<article class="chapter party"'
assert html[html.index(start):].replace('V10.56','V10.55')==old_html[old_html.index(start):]
...
print('PASS: cover bytes/content unchanged, later pages preserved, references valid, original photo unchanged, no-JS/reduced-motion fallback present')
