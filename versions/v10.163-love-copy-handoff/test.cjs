...
(async()=>{
 ...
 console.log('PASS: V10.159 freeze reproduced; V10.163 preserves the V10.160 fix with integer/half/third-pixel scrolling, 8/16/32ms frames, both directions, clamped scroll bounds and photo flights.');
