...
old=here.parent/'v10.102-in-place-turn'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg','classic-reveal.webp','classic-reveal.jpg','titles.css','star-couple.png','star-couple-reference.jpg','rig-atlas.png','rig-atlas-original.png','head-expressions.png','motion.css','paper-surface.js','star-trail.js','page-turn.js','page-turn.css','character-rig.js','rig-atlas.webp','eye-lids.png'):
...
assert 'V10.103' in html
assert html.replace('V10.103','V10.102')==old_html,'Only version labels may change in HTML'
