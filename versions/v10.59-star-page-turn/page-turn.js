(() => {
  ...
  if (!sequence||!sheet||!cover||!stars||!chapter||!math||!window.matchMedia||!window.requestAnimationFrame) return;
  ...
  function configure() {
    ...
    try {
      ...
      const sheetHeight=Math.max(height,cover.offsetHeight+cue.offsetHeight);
