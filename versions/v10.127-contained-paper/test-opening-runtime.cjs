...
async function main(){
  ...
  s.tick(3800+1660);assert.equal(s.body.children[0].children[2].style.opacity,'0.78');
  s.tick(3800+1705);assert.equal(s.body.children[0].children[2].style.opacity,'0.78','One short exposure hold');
  s.tick(3800+2030);assert.equal(s.body.children[0].children[2].style.opacity,'0','No lingering flash overlay');
