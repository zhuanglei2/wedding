...
PREFIX = 'previews/v10.181-20260916-' + fingerprint[:12] + '/'
...
assert any(key.endswith('/v10.180-closer-couple/opening-runtime.js') for key in objects)
...
plan = dict(version='V10.181', baseRevision=REV, sourceFingerprint=fingerprint, bucket=BUCKET,
