...
const math=require('../v10.104-cover-first-paint/page-turn-math.js'),story=require('../v10.114-clean-photo-layer/camera-story-math.js');
...
for(const file of ['index.html']){
 const html=fs.readFileSync(path.join(__dirname,file),'utf8');
 const sheets=[...html.matchAll(/class="camera-print-sheet">([\s\S]*?)<div class="camera-caption"/g)];
...
assert.ok(html.indexOf('src="camera-story.js"')<html.indexOf('src="../v10.112-camera-story/page-turn.js"'),'Camera handoff API is defined before page turn');
