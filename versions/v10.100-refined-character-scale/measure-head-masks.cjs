...
// Historical V10.70 utility; V10.71 does not load these masks.
...
const scope={};vm.runInNewContext(fs.readFileSync(__dirname+'/../v10.70-living-characters/character-rig.js','utf8'),{window:scope});
