...
PREFIX = 'previews/v10.164-20260914-' + fingerprint[:12] + '/'
...
assert b'V10.164' in html and b'href="#our-story"' in html
...
plan = dict(version='V10.164', baseRevision=REV, sourceFingerprint=fingerprint, bucket=BUCKET,
