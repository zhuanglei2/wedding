...
old=here.parent/'v10.101-fluid-flight-loading'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg','classic-reveal.webp','classic-reveal.jpg','titles.css','star-couple.png','star-couple-reference.jpg','rig-atlas.png','rig-atlas-original.png','head-expressions.png','motion.css','paper-surface.js','star-trail.js','page-turn-math.js','character-rig.js','rig-atlas.webp','eye-lids.png'):
...
assert 'V10.102' in html
assert html.replace('V10.102','V10.101')==old_html,'Only version labels may change in HTML'
