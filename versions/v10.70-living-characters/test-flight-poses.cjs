...
(async()=>{
  ...
  vm.runInNewContext(fs.readFileSync(__dirname+'/head-masks.js','utf8'),{window:scope});
  ...
  fs.writeFileSync('/private/tmp/wedding-v1070-flight-poses.png',sheet.toBuffer('image/png'));
