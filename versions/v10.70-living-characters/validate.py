...
old=here.parent/'v10.69-gaze-and-gesture'
...
assert html.replace('V10.70','V10.69').replace(head,'').replace('<script src="head-masks.js" defer></script>\n','')==old_html, 'Unexpected invitation/chapter markup changes'
