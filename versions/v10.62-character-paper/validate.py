...
old=here.parent/'v10.61-tap-cover'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg','classic-reveal.webp','classic-reveal.jpg','titles.css','star-couple.png','star-couple-reference.jpg'):
...
assert 'V10.62' in html
surface='<div class="paper-slices" aria-hidden="true"></div>\n'
assert html.replace(surface,'').split('<main>',1)[1].split('</main>',1)[0]==old_html.split('<main>',1)[1].split('</main>',1)[0], 'Unexpected invitation/chapter markup changes'
