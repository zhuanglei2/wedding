...
old=here.parent/'v10.64-flight-choreography'
html=(here/'index.html').read_text()
old_html=(old/'index.html').read_text()
for name in ('cover.webp','cover.jpg','classic-reveal.webp','classic-reveal.jpg','titles.css','star-couple.png','star-couple-reference.jpg','rig-atlas.png','rig-atlas-original.png','character-rig.js','star-trail.js','page-turn.js'):
...
assert 'V10.65' in html
surface='<div class="paper-slices" aria-hidden="true"></div>\n'
assert html.replace('V10.65','V10.64')==old_html, 'Unexpected invitation/chapter markup changes'
...
for name in ('page-turn-math.js','page-turn.js','character-rig.js','paper-surface.js'):
    assert (here/name).read_bytes()==(old/name).read_bytes(),name+' animation changed'
