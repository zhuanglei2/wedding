...
PREFIX = 'previews/v10.166-20260914-' + fingerprint[:12] + '/'
...
assert b'V10.166' in html and b'href="#our-story"' in html
...
plan = dict(version='V10.166', baseRevision=REV, sourceFingerprint=fingerprint, bucket=BUCKET,
