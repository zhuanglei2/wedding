...
V10.103及19个依赖已同步杭州hq-wedding并校验；www仍解析到香港，尚未迁移域名绑定/HTTPS。迁移进度见 `HANGZHOU_MIGRATION_20260909.md`。
...
V10.103已上传到香港OSS的love.html，并经签名GET逐字节校验。旧入口备份已保存，首页与登记页未变。
