...
最新完整本地婚礼请柬 HTML：`../versions/v10.103-led-departure/index.html`。
页面实际 title 是“庄磊 & 吴郁 · 婚礼请柬 · V10.103”：男孩先倾身带动、女孩稍后回应，牵手加速后衣摆和腿跟随；保留V10.102取消250ms预滚动的原位翻页修复。V10.102、V10.103均未部署、未推送GitHub；离线测试及关键帧检查不代替微信真机验收。微信安全区域适配按用户要求暂缓，未实施。
